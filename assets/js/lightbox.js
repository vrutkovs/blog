  ...
  return (function (e) {
    ...
    function (e, t, n) {
        ...
        (n.className = "".concat(i, "toolbar")),
          ...
          (function (e, t) {
            if (!e.hfs) {
              ...
              s.setAttributeNS(null, "class", "".concat(i, "fso")),
                (e.fso = function () {
                  (e.ifs = 1),
                    (o.title = "Exit fullscreen"),
                    s.setAttributeNS(null, "class", "".concat(i, "fsx")),
      ...
      function Y(e) {
        ...
        (this.runNoSwipeActions = function () {
          ...
          (this.runActions = function () {
            i.swipedX > 0 ? s.runPositiveSwipedXActions() : s.runNegativeSwipedXActions(),
              _(n.container, n.slideSwipingHoverer),
      ...
      function G(e) {
        ...
        this.runActions = function () {
          (t.i = 1),
            r.container.classList.add(v),
            i.removeListeners(),
            c.exitFullscreenOnClose && e.ifs && a.x(),
            setTimeout(function () {
              (t.i = 0),
                (u.isPointering = !1),
                r.container.classList.remove(v),
            ...
            if ("play" != o || t.i(e)) {
              ...
              if (i) {
                ...
                if ("VIDEO" == s) i[o]();
                  ...
                  r &&
                    r.postMessage(
                      '{"event":"command","func":"'.concat(o, 'Video","args":""}'),
                      "*",
                    );
                }
              }
      ...
      function Q(e) {
        ...
        function x() {
          ...
          (b = !0),
            ...
            (r || c.length > 0) && (e.loc = 1),
            K(e),
            e.fs.i(),
            (h.container = document.createElement("div")),
            (h.container.className = "".concat(i, "container ").concat(a, " ").concat(m)),
            ...
            (function (e) {
              for (
                var t = e.props.sources, n = e.resolve, o = n(L), i = n(R), s = n(M, [o, i]), r = 0;
                r < t.length;
                r++
              )
        ...
        e.open = function () {
          ...
          (g.current = n),
            ...
            b ? (v.c(), v.a(), v.b(i), v.b(a), v.b(d), o.dispatch("onShow")) : x(),
          ...
          var e = document.getElementsByTagName("a"),
            t = function (t) {
              ...
              for (
                ...
                if (-1 === r.indexOf(a[l].name) && "data-" === a[l].name.substr(0, 5)) {
                  c[s] || (c[s] = {});
